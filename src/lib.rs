...
# [inline (always)]
pub fn rxfull (& mut self) -> RXFULL_W { RXFULL_W { w : self } } } } } # [doc = "TIMER0"]
...
# [inline (always)]
pub fn zero (& mut self) -> ZERO_W { ZERO_W { w : self } } } } } # [doc = "SDRAM"]
...
# [inline (always)]
pub const fn ptr () -> * const sdram :: RegisterBlock { 0x8200_3800 as * const _ } } impl Deref for SDRAM { type Target = sdram :: RegisterBlock ; # [inline (always)]
...
# [inline (always)]
pub fn dfii_pi0_rddata (& mut self) -> DFII_PI0_RDDATA_W { DFII_PI0_RDDATA_W { w : self } } } } } # [doc = "LEDS"]
...
# [inline (always)]
pub const fn ptr () -> * const leds :: RegisterBlock { 0x8200_4000 as * const _ } } impl Deref for LEDS { type Target = leds :: RegisterBlock ; # [inline (always)]
...
# [inline (always)]
pub const fn ptr () -> * const oled_spi :: RegisterBlock { 0x8200_4800 as * const _ } } impl Deref for OLED_SPI { type Target = oled_spi :: RegisterBlock ; # [inline (always)]
...
# [inline (always)]
pub const fn ptr () -> * const oled_ctl :: RegisterBlock { 0x8200_5000 as * const _ } } impl Deref for OLED_CTL { type Target = oled_ctl :: RegisterBlock ; # [inline (always)]
