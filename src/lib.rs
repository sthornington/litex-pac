...
# [inline (always)]
pub fn out (& mut self) -> OUT_W { OUT_W { w : self } } } } } # [doc = "MATRIX_SPI"]
pub struct MATRIX_SPI { _marker : PhantomData < * const () > } unsafe impl Send for MATRIX_SPI { } impl MATRIX_SPI { # [doc = r"Returns a pointer to the register block"]
# [inline (always)]
pub const fn ptr () -> * const matrix_spi :: RegisterBlock { 0xf000_1800 as * const _ } } impl Deref for MATRIX_SPI { type Target = matrix_spi :: RegisterBlock ; # [inline (always)]
fn deref (& self) -> & Self :: Target { unsafe { & * MATRIX_SPI :: ptr () } } } # [doc = "MATRIX_SPI"]
pub mod matrix_spi { # [doc = r"Register block"]
# [repr (C)]
...
pub LEDS : LEDS , # [doc = "MATRIX_SPI"]
pub MATRIX_SPI : MATRIX_SPI , # [doc = "OLED_CTL"]
