...
# [inline (always)]
pub fn out (& mut self) -> OUT_W { OUT_W { w : self } } } } } # [doc = "OLED_CTL"]
...
# [inline (always)]
pub const fn ptr () -> * const oled_ctl :: RegisterBlock { 0xf000_1800 as * const _ } } impl Deref for OLED_CTL { type Target = oled_ctl :: RegisterBlock ; # [inline (always)]
...
# [inline (always)]
pub const fn ptr () -> * const oled_spi :: RegisterBlock { 0xf000_2000 as * const _ } } impl Deref for OLED_SPI { type Target = oled_spi :: RegisterBlock ; # [inline (always)]
...
# [inline (always)]
pub const fn ptr () -> * const sdram :: RegisterBlock { 0xf000_2800 as * const _ } } impl Deref for SDRAM { type Target = sdram :: RegisterBlock ; # [inline (always)]
...
# [inline (always)]
pub fn rxfull (& mut self) -> RXFULL_W { RXFULL_W { w : self } } } } } # [doc = "VIDEO_TERMINAL_VTG"]
pub struct VIDEO_TERMINAL_VTG { _marker : PhantomData < * const () > } unsafe impl Send for VIDEO_TERMINAL_VTG { } impl VIDEO_TERMINAL_VTG { # [doc = r"Returns a pointer to the register block"]
# [inline (always)]
pub const fn ptr () -> * const video_terminal_vtg :: RegisterBlock { 0xf000_4000 as * const _ } } impl Deref for VIDEO_TERMINAL_VTG { type Target = video_terminal_vtg :: RegisterBlock ; # [inline (always)]
fn deref (& self) -> & Self :: Target { unsafe { & * VIDEO_TERMINAL_VTG :: ptr () } } } # [doc = "VIDEO_TERMINAL_VTG"]
pub mod video_terminal_vtg { # [doc = r"Register block"]
# [repr (C)]
pub struct RegisterBlock { # [doc = "0x00 - "]
...
pub type ENABLE = crate :: Reg < u32 , _ENABLE > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _ENABLE ; # [doc = "`read()` method returns [enable::R](enable::R) reader structure"]
impl crate :: Readable for ENABLE { } # [doc = "`write(|w| ..)` method takes [enable::W](enable::W) writer structure"]
impl crate :: Writable for ENABLE { } # [doc = ""]
pub mod enable { # [doc = "Reader of register ENABLE"]
pub type R = crate :: R < u32 , super :: ENABLE > ; # [doc = "Writer for register ENABLE"]
pub type W = crate :: W < u32 , super :: ENABLE > ; # [doc = "Register ENABLE `reset()`'s with value 0x01"]
impl crate :: ResetValue for super :: ENABLE { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0x01 } } # [doc = "Reader of field `enable`"]
...
# [inline (always)]
pub fn enable (& mut self) -> ENABLE_W { ENABLE_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hres](hres) module"]
pub type HRES = crate :: Reg < u32 , _HRES > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _HRES ; # [doc = "`read()` method returns [hres::R](hres::R) reader structure"]
impl crate :: Readable for HRES { } # [doc = "`write(|w| ..)` method takes [hres::W](hres::W) writer structure"]
impl crate :: Writable for HRES { } # [doc = ""]
pub mod hres { # [doc = "Reader of register HRES"]
pub type R = crate :: R < u32 , super :: HRES > ; # [doc = "Writer for register HRES"]
pub type W = crate :: W < u32 , super :: HRES > ; # [doc = "Register HRES `reset()`'s with value 0x0320"]
impl crate :: ResetValue for super :: HRES { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0x0320 } } # [doc = "Reader of field `hres`"]
pub type HRES_R = crate :: R < u16 , u16 > ; # [doc = "Write proxy for field `hres`"]
pub struct HRES_W < 'a > { w : & 'a mut W , } impl < 'a > HRES_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u16) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x0fff) | ((value as u32) & 0x0fff) ; self . w } } impl R { # [doc = "Bits 0:11"]
# [inline (always)]
pub fn hres (& self) -> HRES_R { HRES_R :: new ((self . bits & 0x0fff) as u16) } } impl W { # [doc = "Bits 0:11"]
# [inline (always)]
pub fn hres (& mut self) -> HRES_W { HRES_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hsync_start](hsync_start) module"]
pub type HSYNC_START = crate :: Reg < u32 , _HSYNC_START > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _HSYNC_START ; # [doc = "`read()` method returns [hsync_start::R](hsync_start::R) reader structure"]
impl crate :: Readable for HSYNC_START { } # [doc = "`write(|w| ..)` method takes [hsync_start::W](hsync_start::W) writer structure"]
impl crate :: Writable for HSYNC_START { } # [doc = ""]
pub mod hsync_start { # [doc = "Reader of register HSYNC_START"]
pub type R = crate :: R < u32 , super :: HSYNC_START > ; # [doc = "Writer for register HSYNC_START"]
pub type W = crate :: W < u32 , super :: HSYNC_START > ; # [doc = "Register HSYNC_START `reset()`'s with value 0x0348"]
impl crate :: ResetValue for super :: HSYNC_START { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0x0348 } } # [doc = "Reader of field `hsync_start`"]
pub type HSYNC_START_R = crate :: R < u16 , u16 > ; # [doc = "Write proxy for field `hsync_start`"]
pub struct HSYNC_START_W < 'a > { w : & 'a mut W , } impl < 'a > HSYNC_START_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u16) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x0fff) | ((value as u32) & 0x0fff) ; self . w } } impl R { # [doc = "Bits 0:11"]
# [inline (always)]
pub fn hsync_start (& self) -> HSYNC_START_R { HSYNC_START_R :: new ((self . bits & 0x0fff) as u16) } } impl W { # [doc = "Bits 0:11"]
# [inline (always)]
pub fn hsync_start (& mut self) -> HSYNC_START_W { HSYNC_START_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hsync_end](hsync_end) module"]
pub type HSYNC_END = crate :: Reg < u32 , _HSYNC_END > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _HSYNC_END ; # [doc = "`read()` method returns [hsync_end::R](hsync_end::R) reader structure"]
impl crate :: Readable for HSYNC_END { } # [doc = "`write(|w| ..)` method takes [hsync_end::W](hsync_end::W) writer structure"]
impl crate :: Writable for HSYNC_END { } # [doc = ""]
pub mod hsync_end { # [doc = "Reader of register HSYNC_END"]
pub type R = crate :: R < u32 , super :: HSYNC_END > ; # [doc = "Writer for register HSYNC_END"]
pub type W = crate :: W < u32 , super :: HSYNC_END > ; # [doc = "Register HSYNC_END `reset()`'s with value 0x03c8"]
impl crate :: ResetValue for super :: HSYNC_END { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0x03c8 } } # [doc = "Reader of field `hsync_end`"]
pub type HSYNC_END_R = crate :: R < u16 , u16 > ; # [doc = "Write proxy for field `hsync_end`"]
pub struct HSYNC_END_W < 'a > { w : & 'a mut W , } impl < 'a > HSYNC_END_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u16) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x0fff) | ((value as u32) & 0x0fff) ; self . w } } impl R { # [doc = "Bits 0:11"]
# [inline (always)]
pub fn hsync_end (& self) -> HSYNC_END_R { HSYNC_END_R :: new ((self . bits & 0x0fff) as u16) } } impl W { # [doc = "Bits 0:11"]
# [inline (always)]
pub fn hsync_end (& mut self) -> HSYNC_END_W { HSYNC_END_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hscan](hscan) module"]
pub type HSCAN = crate :: Reg < u32 , _HSCAN > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _HSCAN ; # [doc = "`read()` method returns [hscan::R](hscan::R) reader structure"]
impl crate :: Readable for HSCAN { } # [doc = "`write(|w| ..)` method takes [hscan::W](hscan::W) writer structure"]
impl crate :: Writable for HSCAN { } # [doc = ""]
pub mod hscan { # [doc = "Reader of register HSCAN"]
pub type R = crate :: R < u32 , super :: HSCAN > ; # [doc = "Writer for register HSCAN"]
pub type W = crate :: W < u32 , super :: HSCAN > ; # [doc = "Register HSCAN `reset()`'s with value 0x0420"]
impl crate :: ResetValue for super :: HSCAN { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0x0420 } } # [doc = "Reader of field `hscan`"]
pub type HSCAN_R = crate :: R < u16 , u16 > ; # [doc = "Write proxy for field `hscan`"]
pub struct HSCAN_W < 'a > { w : & 'a mut W , } impl < 'a > HSCAN_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u16) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x0fff) | ((value as u32) & 0x0fff) ; self . w } } impl R { # [doc = "Bits 0:11"]
# [inline (always)]
pub fn hscan (& self) -> HSCAN_R { HSCAN_R :: new ((self . bits & 0x0fff) as u16) } } impl W { # [doc = "Bits 0:11"]
# [inline (always)]
pub fn hscan (& mut self) -> HSCAN_W { HSCAN_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [vres](vres) module"]
pub type VRES = crate :: Reg < u32 , _VRES > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _VRES ; # [doc = "`read()` method returns [vres::R](vres::R) reader structure"]
impl crate :: Readable for VRES { } # [doc = "`write(|w| ..)` method takes [vres::W](vres::W) writer structure"]
impl crate :: Writable for VRES { } # [doc = ""]
pub mod vres { # [doc = "Reader of register VRES"]
pub type R = crate :: R < u32 , super :: VRES > ; # [doc = "Writer for register VRES"]
pub type W = crate :: W < u32 , super :: VRES > ; # [doc = "Register VRES `reset()`'s with value 0x0258"]
impl crate :: ResetValue for super :: VRES { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0x0258 } } # [doc = "Reader of field `vres`"]
pub type VRES_R = crate :: R < u16 , u16 > ; # [doc = "Write proxy for field `vres`"]
pub struct VRES_W < 'a > { w : & 'a mut W , } impl < 'a > VRES_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u16) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x0fff) | ((value as u32) & 0x0fff) ; self . w } } impl R { # [doc = "Bits 0:11"]
# [inline (always)]
pub fn vres (& self) -> VRES_R { VRES_R :: new ((self . bits & 0x0fff) as u16) } } impl W { # [doc = "Bits 0:11"]
# [inline (always)]
pub fn vres (& mut self) -> VRES_W { VRES_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [vsync_start](vsync_start) module"]
pub type VSYNC_START = crate :: Reg < u32 , _VSYNC_START > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _VSYNC_START ; # [doc = "`read()` method returns [vsync_start::R](vsync_start::R) reader structure"]
impl crate :: Readable for VSYNC_START { } # [doc = "`write(|w| ..)` method takes [vsync_start::W](vsync_start::W) writer structure"]
impl crate :: Writable for VSYNC_START { } # [doc = ""]
pub mod vsync_start { # [doc = "Reader of register VSYNC_START"]
pub type R = crate :: R < u32 , super :: VSYNC_START > ; # [doc = "Writer for register VSYNC_START"]
pub type W = crate :: W < u32 , super :: VSYNC_START > ; # [doc = "Register VSYNC_START `reset()`'s with value 0x0259"]
impl crate :: ResetValue for super :: VSYNC_START { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0x0259 } } # [doc = "Reader of field `vsync_start`"]
pub type VSYNC_START_R = crate :: R < u16 , u16 > ; # [doc = "Write proxy for field `vsync_start`"]
pub struct VSYNC_START_W < 'a > { w : & 'a mut W , } impl < 'a > VSYNC_START_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u16) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x0fff) | ((value as u32) & 0x0fff) ; self . w } } impl R { # [doc = "Bits 0:11"]
# [inline (always)]
pub fn vsync_start (& self) -> VSYNC_START_R { VSYNC_START_R :: new ((self . bits & 0x0fff) as u16) } } impl W { # [doc = "Bits 0:11"]
# [inline (always)]
pub fn vsync_start (& mut self) -> VSYNC_START_W { VSYNC_START_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [vsync_end](vsync_end) module"]
pub type VSYNC_END = crate :: Reg < u32 , _VSYNC_END > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _VSYNC_END ; # [doc = "`read()` method returns [vsync_end::R](vsync_end::R) reader structure"]
impl crate :: Readable for VSYNC_END { } # [doc = "`write(|w| ..)` method takes [vsync_end::W](vsync_end::W) writer structure"]
impl crate :: Writable for VSYNC_END { } # [doc = ""]
pub mod vsync_end { # [doc = "Reader of register VSYNC_END"]
pub type R = crate :: R < u32 , super :: VSYNC_END > ; # [doc = "Writer for register VSYNC_END"]
pub type W = crate :: W < u32 , super :: VSYNC_END > ; # [doc = "Register VSYNC_END `reset()`'s with value 0x025d"]
impl crate :: ResetValue for super :: VSYNC_END { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0x025d } } # [doc = "Reader of field `vsync_end`"]
pub type VSYNC_END_R = crate :: R < u16 , u16 > ; # [doc = "Write proxy for field `vsync_end`"]
pub struct VSYNC_END_W < 'a > { w : & 'a mut W , } impl < 'a > VSYNC_END_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u16) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x0fff) | ((value as u32) & 0x0fff) ; self . w } } impl R { # [doc = "Bits 0:11"]
# [inline (always)]
pub fn vsync_end (& self) -> VSYNC_END_R { VSYNC_END_R :: new ((self . bits & 0x0fff) as u16) } } impl W { # [doc = "Bits 0:11"]
# [inline (always)]
pub fn vsync_end (& mut self) -> VSYNC_END_W { VSYNC_END_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [vscan](vscan) module"]
pub type VSCAN = crate :: Reg < u32 , _VSCAN > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _VSCAN ; # [doc = "`read()` method returns [vscan::R](vscan::R) reader structure"]
impl crate :: Readable for VSCAN { } # [doc = "`write(|w| ..)` method takes [vscan::W](vscan::W) writer structure"]
impl crate :: Writable for VSCAN { } # [doc = ""]
pub mod vscan { # [doc = "Reader of register VSCAN"]
pub type R = crate :: R < u32 , super :: VSCAN > ; # [doc = "Writer for register VSCAN"]
pub type W = crate :: W < u32 , super :: VSCAN > ; # [doc = "Register VSCAN `reset()`'s with value 0x0274"]
impl crate :: ResetValue for super :: VSCAN { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0x0274 } } # [doc = "Reader of field `vscan`"]
pub type VSCAN_R = crate :: R < u16 , u16 > ; # [doc = "Write proxy for field `vscan`"]
pub struct VSCAN_W < 'a > { w : & 'a mut W , } impl < 'a > VSCAN_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u16) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x0fff) | ((value as u32) & 0x0fff) ; self . w } } impl R { # [doc = "Bits 0:11"]
# [inline (always)]
pub fn vscan (& self) -> VSCAN_R { VSCAN_R :: new ((self . bits & 0x0fff) as u16) } } impl W { # [doc = "Bits 0:11"]
# [inline (always)]
pub fn vscan (& mut self) -> VSCAN_W { VSCAN_W { w : self } } } } } # [no_mangle]
...
pub LEDS : LEDS , # [doc = "OLED_CTL"]
pub OLED_CTL : OLED_CTL , # [doc = "OLED_SPI"]
pub OLED_SPI : OLED_SPI , # [doc = "SDRAM"]
pub SDRAM : SDRAM , # [doc = "TIMER0"]
pub TIMER0 : TIMER0 , # [doc = "UART"]
pub UART : UART , # [doc = "VIDEO_TERMINAL_VTG"]
pub VIDEO_TERMINAL_VTG : VIDEO_TERMINAL_VTG , } impl Peripherals { # [doc = r"Returns all the peripherals *once*"]
# [inline]
...
# [inline]
pub unsafe fn steal () -> Self { DEVICE_PERIPHERALS = true ; Peripherals { CTRL : CTRL { _marker : PhantomData } , IDENTIFIER_MEM : IDENTIFIER_MEM { _marker : PhantomData } , LEDS : LEDS { _marker : PhantomData } , OLED_CTL : OLED_CTL { _marker : PhantomData } , OLED_SPI : OLED_SPI { _marker : PhantomData } , SDRAM : SDRAM { _marker : PhantomData } , TIMER0 : TIMER0 { _marker : PhantomData } , UART : UART { _marker : PhantomData } , VIDEO_TERMINAL_VTG : VIDEO_TERMINAL_VTG { _marker : PhantomData } , } } }