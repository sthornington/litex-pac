...
impl crate :: Readable for BUS_ERRORS { } # [doc = "Total number of Wishbone bus errors (timeouts) since start."]
...
# [inline (always)]
pub fn bus_errors (& self) -> BUS_ERRORS_R { BUS_ERRORS_R :: new ((self . bits & 0xffff_ffff) as u32) } } } } # [doc = "IDENTIFIER_MEM"]
...
# [inline (always)]
pub const fn ptr () -> * const identifier_mem :: RegisterBlock { 0x8200_1000 as * const _ } } impl Deref for IDENTIFIER_MEM { type Target = identifier_mem :: RegisterBlock ; # [inline (always)]
...
# [inline (always)]
pub fn identifier_mem (& mut self) -> IDENTIFIER_MEM_W { IDENTIFIER_MEM_W { w : self } } } } } # [doc = "UART_PHY"]
pub struct UART_PHY { _marker : PhantomData < * const () > } unsafe impl Send for UART_PHY { } impl UART_PHY { # [doc = r"Returns a pointer to the register block"]
# [inline (always)]
pub const fn ptr () -> * const uart_phy :: RegisterBlock { 0x8200_1800 as * const _ } } impl Deref for UART_PHY { type Target = uart_phy :: RegisterBlock ; # [inline (always)]
fn deref (& self) -> & Self :: Target { unsafe { & * UART_PHY :: ptr () } } } # [doc = "UART_PHY"]
pub mod uart_phy { # [doc = r"Register block"]
# [repr (C)]
pub struct RegisterBlock { # [doc = "0x00 - "]
pub tuning_word : TUNING_WORD , } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tuning_word](tuning_word) module"]
pub type TUNING_WORD = crate :: Reg < u32 , _TUNING_WORD > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _TUNING_WORD ; # [doc = "`read()` method returns [tuning_word::R](tuning_word::R) reader structure"]
impl crate :: Readable for TUNING_WORD { } # [doc = "`write(|w| ..)` method takes [tuning_word::W](tuning_word::W) writer structure"]
impl crate :: Writable for TUNING_WORD { } # [doc = ""]
pub mod tuning_word { # [doc = "Reader of register TUNING_WORD"]
pub type R = crate :: R < u32 , super :: TUNING_WORD > ; # [doc = "Writer for register TUNING_WORD"]
pub type W = crate :: W < u32 , super :: TUNING_WORD > ; # [doc = "Register TUNING_WORD `reset()`'s with value 0x0096_feb4"]
impl crate :: ResetValue for super :: TUNING_WORD { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0x0096_feb4 } } # [doc = "Reader of field `tuning_word`"]
pub type TUNING_WORD_R = crate :: R < u32 , u32 > ; # [doc = "Write proxy for field `tuning_word`"]
...
# [inline (always)]
pub fn tuning_word (& mut self) -> TUNING_WORD_W { TUNING_WORD_W { w : self } } } } } # [doc = "UART"]
...
# [inline (always)]
pub const fn ptr () -> * const uart :: RegisterBlock { 0x8200_2000 as * const _ } } impl Deref for UART { type Target = uart :: RegisterBlock ; # [inline (always)]
...
impl crate :: Readable for TXEMPTY { } # [doc = ""]
pub mod txempty { # [doc = "Reader of register TXEMPTY"]
pub type R = crate :: R < u32 , super :: TXEMPTY > ; # [doc = "Reader of field `txempty`"]
pub type TXEMPTY_R = crate :: R < bool , bool > ; impl R { # [doc = "Bit 0"]
# [inline (always)]
...
impl crate :: Readable for RXFULL { } # [doc = ""]
pub mod rxfull { # [doc = "Reader of register RXFULL"]
pub type R = crate :: R < u32 , super :: RXFULL > ; # [doc = "Reader of field `rxfull`"]
pub type RXFULL_R = crate :: R < bool , bool > ; impl R { # [doc = "Bit 0"]
# [inline (always)]
pub fn rxfull (& self) -> RXFULL_R { RXFULL_R :: new ((self . bits & 0x01) != 0) } } } } # [doc = "TIMER0"]
...
# [inline (always)]
pub const fn ptr () -> * const timer0 :: RegisterBlock { 0x8200_2800 as * const _ } } impl Deref for TIMER0 { type Target = timer0 :: RegisterBlock ; # [inline (always)]
...
# [inline (always)]
pub fn enable (& mut self) -> ENABLE_W { ENABLE_W { w : self } } } } } # [doc = "SDRAM"]
...
# [inline (always)]
pub const fn ptr () -> * const sdram :: RegisterBlock { 0x8200_3000 as * const _ } } impl Deref for SDRAM { type Target = sdram :: RegisterBlock ; # [inline (always)]
...
impl crate :: Readable for DFII_PI0_RDDATA { } # [doc = ""]
pub mod dfii_pi0_rddata { # [doc = "Reader of register DFII_PI0_RDDATA"]
pub type R = crate :: R < u32 , super :: DFII_PI0_RDDATA > ; # [doc = "Reader of field `dfii_pi0_rddata`"]
pub type DFII_PI0_RDDATA_R = crate :: R < u16 , u16 > ; impl R { # [doc = "Bits 0:15"]
# [inline (always)]
pub fn dfii_pi0_rddata (& self) -> DFII_PI0_RDDATA_R { DFII_PI0_RDDATA_R :: new ((self . bits & 0xffff) as u16) } } } } # [doc = "LEDS"]
...
# [inline (always)]
pub const fn ptr () -> * const leds :: RegisterBlock { 0x8200_3800 as * const _ } } impl Deref for LEDS { type Target = leds :: RegisterBlock ; # [inline (always)]
...
# [inline (always)]
pub const fn ptr () -> * const oled_spi :: RegisterBlock { 0x8200_4000 as * const _ } } impl Deref for OLED_SPI { type Target = oled_spi :: RegisterBlock ; # [inline (always)]
...
impl crate :: Readable for STATUS { } # [doc = "SPI Status."]
pub mod status { # [doc = "Reader of register STATUS"]
pub type R = crate :: R < u32 , super :: STATUS > ; # [doc = "Reader of field `done`"]
pub type DONE_R = crate :: R < bool , bool > ; impl R { # [doc = "Bit 0 - SPI Xfer done when read as ``1``."]
# [inline (always)]
pub fn done (& self) -> DONE_R { DONE_R :: new ((self . bits & 0x01) != 0) } } } # [doc = "SPI MOSI data (MSB-first serialization).\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [mosi](mosi) module"]
...
impl crate :: Readable for MISO { } # [doc = "SPI MISO data (MSB-first de-serialization)."]
pub mod miso { # [doc = "Reader of register MISO"]
pub type R = crate :: R < u32 , super :: MISO > ; # [doc = "Reader of field `miso`"]
pub type MISO_R = crate :: R < u8 , u8 > ; impl R { # [doc = "Bits 0:7"]
# [inline (always)]
pub fn miso (& self) -> MISO_R { MISO_R :: new ((self . bits & 0xff) as u8) } } } # [doc = "SPI Chip Select.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cs](cs) module"]
...
# [inline (always)]
pub fn clk_divider (& mut self) -> CLK_DIVIDER_W { CLK_DIVIDER_W { w : self } } } } } # [doc = "OLED_CTL"]
...
# [inline (always)]
pub const fn ptr () -> * const oled_ctl :: RegisterBlock { 0x8200_4800 as * const _ } } impl Deref for OLED_CTL { type Target = oled_ctl :: RegisterBlock ; # [inline (always)]
...
# [inline (always)]
pub fn out (& mut self) -> OUT_W { OUT_W { w : self } } } } } # [no_mangle]
