...
# [inline (always)]
pub fn bus_errors (& mut self) -> BUS_ERRORS_W { BUS_ERRORS_W { w : self } } } } } # [doc = "DDRPHY"]
pub struct DDRPHY { _marker : PhantomData < * const () > } unsafe impl Send for DDRPHY { } impl DDRPHY { # [doc = r"Returns a pointer to the register block"]
# [inline (always)]
pub const fn ptr () -> * const ddrphy :: RegisterBlock { 0xf000_0800 as * const _ } } impl Deref for DDRPHY { type Target = ddrphy :: RegisterBlock ; # [inline (always)]
fn deref (& self) -> & Self :: Target { unsafe { & * DDRPHY :: ptr () } } } # [doc = "DDRPHY"]
pub mod ddrphy { # [doc = r"Register block"]
# [repr (C)]
pub struct RegisterBlock { # [doc = "0x00 - "]
pub rst : RST , # [doc = "0x04 - "]
pub half_sys8x_taps : HALF_SYS8X_TAPS , # [doc = "0x08 - "]
pub wlevel_en : WLEVEL_EN , # [doc = "0x0c - "]
pub wlevel_strobe : WLEVEL_STROBE , # [doc = "0x10 - "]
pub dly_sel : DLY_SEL , # [doc = "0x14 - "]
pub rdly_dq_rst : RDLY_DQ_RST , # [doc = "0x18 - "]
pub rdly_dq_inc : RDLY_DQ_INC , # [doc = "0x1c - "]
pub rdly_dq_bitslip_rst : RDLY_DQ_BITSLIP_RST , # [doc = "0x20 - "]
pub rdly_dq_bitslip : RDLY_DQ_BITSLIP , # [doc = "0x24 - "]
pub wdly_dq_bitslip_rst : WDLY_DQ_BITSLIP_RST , # [doc = "0x28 - "]
pub wdly_dq_bitslip : WDLY_DQ_BITSLIP , # [doc = "0x2c - "]
pub rdphase : RDPHASE , # [doc = "0x30 - "]
pub wrphase : WRPHASE , } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rst](rst) module"]
pub type RST = crate :: Reg < u32 , _RST > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _RST ; # [doc = "`read()` method returns [rst::R](rst::R) reader structure"]
impl crate :: Readable for RST { } # [doc = "`write(|w| ..)` method takes [rst::W](rst::W) writer structure"]
impl crate :: Writable for RST { } # [doc = ""]
pub mod rst { # [doc = "Reader of register RST"]
pub type R = crate :: R < u32 , super :: RST > ; # [doc = "Writer for register RST"]
pub type W = crate :: W < u32 , super :: RST > ; # [doc = "Register RST `reset()`'s with value 0"]
impl crate :: ResetValue for super :: RST { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `rst`"]
pub type RST_R = crate :: R < bool , bool > ; # [doc = "Write proxy for field `rst`"]
pub struct RST_W < 'a > { w : & 'a mut W , } impl < 'a > RST_W < 'a > { # [doc = r"Sets the field bit"]
# [inline (always)]
pub fn set_bit (self) -> & 'a mut W { self . bit (true) } # [doc = r"Clears the field bit"]
# [inline (always)]
pub fn clear_bit (self) -> & 'a mut W { self . bit (false) } # [doc = r"Writes raw bits to the field"]
...
pub fn bit (self , value : bool) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x01) | ((value as u32) & 0x01) ; self . w } } impl R { # [doc = "Bit 0"]
# [inline (always)]
pub fn rst (& self) -> RST_R { RST_R :: new ((self . bits & 0x01) != 0) } } impl W { # [doc = "Bit 0"]
# [inline (always)]
pub fn rst (& mut self) -> RST_W { RST_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [half_sys8x_taps](half_sys8x_taps) module"]
pub type HALF_SYS8X_TAPS = crate :: Reg < u32 , _HALF_SYS8X_TAPS > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _HALF_SYS8X_TAPS ; # [doc = "`read()` method returns [half_sys8x_taps::R](half_sys8x_taps::R) reader structure"]
impl crate :: Readable for HALF_SYS8X_TAPS { } # [doc = "`write(|w| ..)` method takes [half_sys8x_taps::W](half_sys8x_taps::W) writer structure"]
impl crate :: Writable for HALF_SYS8X_TAPS { } # [doc = ""]
pub mod half_sys8x_taps { # [doc = "Reader of register HALF_SYS8X_TAPS"]
pub type R = crate :: R < u32 , super :: HALF_SYS8X_TAPS > ; # [doc = "Writer for register HALF_SYS8X_TAPS"]
pub type W = crate :: W < u32 , super :: HALF_SYS8X_TAPS > ; # [doc = "Register HALF_SYS8X_TAPS `reset()`'s with value 0x08"]
impl crate :: ResetValue for super :: HALF_SYS8X_TAPS { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0x08 } } # [doc = "Reader of field `half_sys8x_taps`"]
pub type HALF_SYS8X_TAPS_R = crate :: R < u8 , u8 > ; # [doc = "Write proxy for field `half_sys8x_taps`"]
pub struct HALF_SYS8X_TAPS_W < 'a > { w : & 'a mut W , } impl < 'a > HALF_SYS8X_TAPS_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u8) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x1f) | ((value as u32) & 0x1f) ; self . w } } impl R { # [doc = "Bits 0:4"]
# [inline (always)]
pub fn half_sys8x_taps (& self) -> HALF_SYS8X_TAPS_R { HALF_SYS8X_TAPS_R :: new ((self . bits & 0x1f) as u8) } } impl W { # [doc = "Bits 0:4"]
# [inline (always)]
pub fn half_sys8x_taps (& mut self) -> HALF_SYS8X_TAPS_W { HALF_SYS8X_TAPS_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [wlevel_en](wlevel_en) module"]
pub type WLEVEL_EN = crate :: Reg < u32 , _WLEVEL_EN > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _WLEVEL_EN ; # [doc = "`read()` method returns [wlevel_en::R](wlevel_en::R) reader structure"]
impl crate :: Readable for WLEVEL_EN { } # [doc = "`write(|w| ..)` method takes [wlevel_en::W](wlevel_en::W) writer structure"]
impl crate :: Writable for WLEVEL_EN { } # [doc = ""]
pub mod wlevel_en { # [doc = "Reader of register WLEVEL_EN"]
pub type R = crate :: R < u32 , super :: WLEVEL_EN > ; # [doc = "Writer for register WLEVEL_EN"]
pub type W = crate :: W < u32 , super :: WLEVEL_EN > ; # [doc = "Register WLEVEL_EN `reset()`'s with value 0"]
impl crate :: ResetValue for super :: WLEVEL_EN { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `wlevel_en`"]
pub type WLEVEL_EN_R = crate :: R < bool , bool > ; # [doc = "Write proxy for field `wlevel_en`"]
pub struct WLEVEL_EN_W < 'a > { w : & 'a mut W , } impl < 'a > WLEVEL_EN_W < 'a > { # [doc = r"Sets the field bit"]
# [inline (always)]
pub fn set_bit (self) -> & 'a mut W { self . bit (true) } # [doc = r"Clears the field bit"]
# [inline (always)]
pub fn clear_bit (self) -> & 'a mut W { self . bit (false) } # [doc = r"Writes raw bits to the field"]
...
pub fn bit (self , value : bool) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x01) | ((value as u32) & 0x01) ; self . w } } impl R { # [doc = "Bit 0"]
# [inline (always)]
pub fn wlevel_en (& self) -> WLEVEL_EN_R { WLEVEL_EN_R :: new ((self . bits & 0x01) != 0) } } impl W { # [doc = "Bit 0"]
# [inline (always)]
pub fn wlevel_en (& mut self) -> WLEVEL_EN_W { WLEVEL_EN_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [wlevel_strobe](wlevel_strobe) module"]
pub type WLEVEL_STROBE = crate :: Reg < u32 , _WLEVEL_STROBE > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _WLEVEL_STROBE ; # [doc = "`read()` method returns [wlevel_strobe::R](wlevel_strobe::R) reader structure"]
impl crate :: Readable for WLEVEL_STROBE { } # [doc = "`write(|w| ..)` method takes [wlevel_strobe::W](wlevel_strobe::W) writer structure"]
impl crate :: Writable for WLEVEL_STROBE { } # [doc = ""]
pub mod wlevel_strobe { # [doc = "Reader of register WLEVEL_STROBE"]
pub type R = crate :: R < u32 , super :: WLEVEL_STROBE > ; # [doc = "Writer for register WLEVEL_STROBE"]
pub type W = crate :: W < u32 , super :: WLEVEL_STROBE > ; # [doc = "Register WLEVEL_STROBE `reset()`'s with value 0"]
impl crate :: ResetValue for super :: WLEVEL_STROBE { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `wlevel_strobe`"]
pub type WLEVEL_STROBE_R = crate :: R < bool , bool > ; # [doc = "Write proxy for field `wlevel_strobe`"]
pub struct WLEVEL_STROBE_W < 'a > { w : & 'a mut W , } impl < 'a > WLEVEL_STROBE_W < 'a > { # [doc = r"Sets the field bit"]
# [inline (always)]
pub fn set_bit (self) -> & 'a mut W { self . bit (true) } # [doc = r"Clears the field bit"]
# [inline (always)]
pub fn clear_bit (self) -> & 'a mut W { self . bit (false) } # [doc = r"Writes raw bits to the field"]
...
pub fn bit (self , value : bool) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x01) | ((value as u32) & 0x01) ; self . w } } impl R { # [doc = "Bit 0"]
# [inline (always)]
pub fn wlevel_strobe (& self) -> WLEVEL_STROBE_R { WLEVEL_STROBE_R :: new ((self . bits & 0x01) != 0) } } impl W { # [doc = "Bit 0"]
# [inline (always)]
pub fn wlevel_strobe (& mut self) -> WLEVEL_STROBE_W { WLEVEL_STROBE_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dly_sel](dly_sel) module"]
pub type DLY_SEL = crate :: Reg < u32 , _DLY_SEL > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _DLY_SEL ; # [doc = "`read()` method returns [dly_sel::R](dly_sel::R) reader structure"]
impl crate :: Readable for DLY_SEL { } # [doc = "`write(|w| ..)` method takes [dly_sel::W](dly_sel::W) writer structure"]
impl crate :: Writable for DLY_SEL { } # [doc = ""]
pub mod dly_sel { # [doc = "Reader of register DLY_SEL"]
pub type R = crate :: R < u32 , super :: DLY_SEL > ; # [doc = "Writer for register DLY_SEL"]
pub type W = crate :: W < u32 , super :: DLY_SEL > ; # [doc = "Register DLY_SEL `reset()`'s with value 0"]
impl crate :: ResetValue for super :: DLY_SEL { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `dly_sel`"]
pub type DLY_SEL_R = crate :: R < u8 , u8 > ; # [doc = "Write proxy for field `dly_sel`"]
pub struct DLY_SEL_W < 'a > { w : & 'a mut W , } impl < 'a > DLY_SEL_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u8) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x03) | ((value as u32) & 0x03) ; self . w } } impl R { # [doc = "Bits 0:1"]
# [inline (always)]
pub fn dly_sel (& self) -> DLY_SEL_R { DLY_SEL_R :: new ((self . bits & 0x03) as u8) } } impl W { # [doc = "Bits 0:1"]
# [inline (always)]
pub fn dly_sel (& mut self) -> DLY_SEL_W { DLY_SEL_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rdly_dq_rst](rdly_dq_rst) module"]
pub type RDLY_DQ_RST = crate :: Reg < u32 , _RDLY_DQ_RST > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _RDLY_DQ_RST ; # [doc = "`read()` method returns [rdly_dq_rst::R](rdly_dq_rst::R) reader structure"]
impl crate :: Readable for RDLY_DQ_RST { } # [doc = "`write(|w| ..)` method takes [rdly_dq_rst::W](rdly_dq_rst::W) writer structure"]
impl crate :: Writable for RDLY_DQ_RST { } # [doc = ""]
pub mod rdly_dq_rst { # [doc = "Reader of register RDLY_DQ_RST"]
pub type R = crate :: R < u32 , super :: RDLY_DQ_RST > ; # [doc = "Writer for register RDLY_DQ_RST"]
pub type W = crate :: W < u32 , super :: RDLY_DQ_RST > ; # [doc = "Register RDLY_DQ_RST `reset()`'s with value 0"]
impl crate :: ResetValue for super :: RDLY_DQ_RST { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `rdly_dq_rst`"]
pub type RDLY_DQ_RST_R = crate :: R < bool , bool > ; # [doc = "Write proxy for field `rdly_dq_rst`"]
pub struct RDLY_DQ_RST_W < 'a > { w : & 'a mut W , } impl < 'a > RDLY_DQ_RST_W < 'a > { # [doc = r"Sets the field bit"]
# [inline (always)]
pub fn set_bit (self) -> & 'a mut W { self . bit (true) } # [doc = r"Clears the field bit"]
# [inline (always)]
pub fn clear_bit (self) -> & 'a mut W { self . bit (false) } # [doc = r"Writes raw bits to the field"]
...
pub fn bit (self , value : bool) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x01) | ((value as u32) & 0x01) ; self . w } } impl R { # [doc = "Bit 0"]
# [inline (always)]
pub fn rdly_dq_rst (& self) -> RDLY_DQ_RST_R { RDLY_DQ_RST_R :: new ((self . bits & 0x01) != 0) } } impl W { # [doc = "Bit 0"]
# [inline (always)]
pub fn rdly_dq_rst (& mut self) -> RDLY_DQ_RST_W { RDLY_DQ_RST_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rdly_dq_inc](rdly_dq_inc) module"]
pub type RDLY_DQ_INC = crate :: Reg < u32 , _RDLY_DQ_INC > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _RDLY_DQ_INC ; # [doc = "`read()` method returns [rdly_dq_inc::R](rdly_dq_inc::R) reader structure"]
impl crate :: Readable for RDLY_DQ_INC { } # [doc = "`write(|w| ..)` method takes [rdly_dq_inc::W](rdly_dq_inc::W) writer structure"]
impl crate :: Writable for RDLY_DQ_INC { } # [doc = ""]
pub mod rdly_dq_inc { # [doc = "Reader of register RDLY_DQ_INC"]
pub type R = crate :: R < u32 , super :: RDLY_DQ_INC > ; # [doc = "Writer for register RDLY_DQ_INC"]
pub type W = crate :: W < u32 , super :: RDLY_DQ_INC > ; # [doc = "Register RDLY_DQ_INC `reset()`'s with value 0"]
impl crate :: ResetValue for super :: RDLY_DQ_INC { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `rdly_dq_inc`"]
pub type RDLY_DQ_INC_R = crate :: R < bool , bool > ; # [doc = "Write proxy for field `rdly_dq_inc`"]
pub struct RDLY_DQ_INC_W < 'a > { w : & 'a mut W , } impl < 'a > RDLY_DQ_INC_W < 'a > { # [doc = r"Sets the field bit"]
# [inline (always)]
pub fn set_bit (self) -> & 'a mut W { self . bit (true) } # [doc = r"Clears the field bit"]
# [inline (always)]
pub fn clear_bit (self) -> & 'a mut W { self . bit (false) } # [doc = r"Writes raw bits to the field"]
...
pub fn bit (self , value : bool) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x01) | ((value as u32) & 0x01) ; self . w } } impl R { # [doc = "Bit 0"]
# [inline (always)]
pub fn rdly_dq_inc (& self) -> RDLY_DQ_INC_R { RDLY_DQ_INC_R :: new ((self . bits & 0x01) != 0) } } impl W { # [doc = "Bit 0"]
# [inline (always)]
pub fn rdly_dq_inc (& mut self) -> RDLY_DQ_INC_W { RDLY_DQ_INC_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rdly_dq_bitslip_rst](rdly_dq_bitslip_rst) module"]
pub type RDLY_DQ_BITSLIP_RST = crate :: Reg < u32 , _RDLY_DQ_BITSLIP_RST > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _RDLY_DQ_BITSLIP_RST ; # [doc = "`read()` method returns [rdly_dq_bitslip_rst::R](rdly_dq_bitslip_rst::R) reader structure"]
impl crate :: Readable for RDLY_DQ_BITSLIP_RST { } # [doc = "`write(|w| ..)` method takes [rdly_dq_bitslip_rst::W](rdly_dq_bitslip_rst::W) writer structure"]
impl crate :: Writable for RDLY_DQ_BITSLIP_RST { } # [doc = ""]
pub mod rdly_dq_bitslip_rst { # [doc = "Reader of register RDLY_DQ_BITSLIP_RST"]
pub type R = crate :: R < u32 , super :: RDLY_DQ_BITSLIP_RST > ; # [doc = "Writer for register RDLY_DQ_BITSLIP_RST"]
pub type W = crate :: W < u32 , super :: RDLY_DQ_BITSLIP_RST > ; # [doc = "Register RDLY_DQ_BITSLIP_RST `reset()`'s with value 0"]
impl crate :: ResetValue for super :: RDLY_DQ_BITSLIP_RST { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `rdly_dq_bitslip_rst`"]
pub type RDLY_DQ_BITSLIP_RST_R = crate :: R < bool , bool > ; # [doc = "Write proxy for field `rdly_dq_bitslip_rst`"]
pub struct RDLY_DQ_BITSLIP_RST_W < 'a > { w : & 'a mut W , } impl < 'a > RDLY_DQ_BITSLIP_RST_W < 'a > { # [doc = r"Sets the field bit"]
# [inline (always)]
pub fn set_bit (self) -> & 'a mut W { self . bit (true) } # [doc = r"Clears the field bit"]
# [inline (always)]
pub fn clear_bit (self) -> & 'a mut W { self . bit (false) } # [doc = r"Writes raw bits to the field"]
...
pub fn bit (self , value : bool) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x01) | ((value as u32) & 0x01) ; self . w } } impl R { # [doc = "Bit 0"]
# [inline (always)]
pub fn rdly_dq_bitslip_rst (& self) -> RDLY_DQ_BITSLIP_RST_R { RDLY_DQ_BITSLIP_RST_R :: new ((self . bits & 0x01) != 0) } } impl W { # [doc = "Bit 0"]
# [inline (always)]
pub fn rdly_dq_bitslip_rst (& mut self) -> RDLY_DQ_BITSLIP_RST_W { RDLY_DQ_BITSLIP_RST_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rdly_dq_bitslip](rdly_dq_bitslip) module"]
pub type RDLY_DQ_BITSLIP = crate :: Reg < u32 , _RDLY_DQ_BITSLIP > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _RDLY_DQ_BITSLIP ; # [doc = "`read()` method returns [rdly_dq_bitslip::R](rdly_dq_bitslip::R) reader structure"]
impl crate :: Readable for RDLY_DQ_BITSLIP { } # [doc = "`write(|w| ..)` method takes [rdly_dq_bitslip::W](rdly_dq_bitslip::W) writer structure"]
impl crate :: Writable for RDLY_DQ_BITSLIP { } # [doc = ""]
pub mod rdly_dq_bitslip { # [doc = "Reader of register RDLY_DQ_BITSLIP"]
pub type R = crate :: R < u32 , super :: RDLY_DQ_BITSLIP > ; # [doc = "Writer for register RDLY_DQ_BITSLIP"]
pub type W = crate :: W < u32 , super :: RDLY_DQ_BITSLIP > ; # [doc = "Register RDLY_DQ_BITSLIP `reset()`'s with value 0"]
impl crate :: ResetValue for super :: RDLY_DQ_BITSLIP { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `rdly_dq_bitslip`"]
pub type RDLY_DQ_BITSLIP_R = crate :: R < bool , bool > ; # [doc = "Write proxy for field `rdly_dq_bitslip`"]
pub struct RDLY_DQ_BITSLIP_W < 'a > { w : & 'a mut W , } impl < 'a > RDLY_DQ_BITSLIP_W < 'a > { # [doc = r"Sets the field bit"]
# [inline (always)]
pub fn set_bit (self) -> & 'a mut W { self . bit (true) } # [doc = r"Clears the field bit"]
# [inline (always)]
pub fn clear_bit (self) -> & 'a mut W { self . bit (false) } # [doc = r"Writes raw bits to the field"]
...
pub fn bit (self , value : bool) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x01) | ((value as u32) & 0x01) ; self . w } } impl R { # [doc = "Bit 0"]
# [inline (always)]
pub fn rdly_dq_bitslip (& self) -> RDLY_DQ_BITSLIP_R { RDLY_DQ_BITSLIP_R :: new ((self . bits & 0x01) != 0) } } impl W { # [doc = "Bit 0"]
# [inline (always)]
pub fn rdly_dq_bitslip (& mut self) -> RDLY_DQ_BITSLIP_W { RDLY_DQ_BITSLIP_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [wdly_dq_bitslip_rst](wdly_dq_bitslip_rst) module"]
pub type WDLY_DQ_BITSLIP_RST = crate :: Reg < u32 , _WDLY_DQ_BITSLIP_RST > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _WDLY_DQ_BITSLIP_RST ; # [doc = "`read()` method returns [wdly_dq_bitslip_rst::R](wdly_dq_bitslip_rst::R) reader structure"]
impl crate :: Readable for WDLY_DQ_BITSLIP_RST { } # [doc = "`write(|w| ..)` method takes [wdly_dq_bitslip_rst::W](wdly_dq_bitslip_rst::W) writer structure"]
impl crate :: Writable for WDLY_DQ_BITSLIP_RST { } # [doc = ""]
pub mod wdly_dq_bitslip_rst { # [doc = "Reader of register WDLY_DQ_BITSLIP_RST"]
pub type R = crate :: R < u32 , super :: WDLY_DQ_BITSLIP_RST > ; # [doc = "Writer for register WDLY_DQ_BITSLIP_RST"]
pub type W = crate :: W < u32 , super :: WDLY_DQ_BITSLIP_RST > ; # [doc = "Register WDLY_DQ_BITSLIP_RST `reset()`'s with value 0"]
impl crate :: ResetValue for super :: WDLY_DQ_BITSLIP_RST { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `wdly_dq_bitslip_rst`"]
pub type WDLY_DQ_BITSLIP_RST_R = crate :: R < bool , bool > ; # [doc = "Write proxy for field `wdly_dq_bitslip_rst`"]
pub struct WDLY_DQ_BITSLIP_RST_W < 'a > { w : & 'a mut W , } impl < 'a > WDLY_DQ_BITSLIP_RST_W < 'a > { # [doc = r"Sets the field bit"]
# [inline (always)]
pub fn set_bit (self) -> & 'a mut W { self . bit (true) } # [doc = r"Clears the field bit"]
# [inline (always)]
pub fn clear_bit (self) -> & 'a mut W { self . bit (false) } # [doc = r"Writes raw bits to the field"]
...
pub fn bit (self , value : bool) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x01) | ((value as u32) & 0x01) ; self . w } } impl R { # [doc = "Bit 0"]
# [inline (always)]
pub fn wdly_dq_bitslip_rst (& self) -> WDLY_DQ_BITSLIP_RST_R { WDLY_DQ_BITSLIP_RST_R :: new ((self . bits & 0x01) != 0) } } impl W { # [doc = "Bit 0"]
# [inline (always)]
pub fn wdly_dq_bitslip_rst (& mut self) -> WDLY_DQ_BITSLIP_RST_W { WDLY_DQ_BITSLIP_RST_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [wdly_dq_bitslip](wdly_dq_bitslip) module"]
pub type WDLY_DQ_BITSLIP = crate :: Reg < u32 , _WDLY_DQ_BITSLIP > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _WDLY_DQ_BITSLIP ; # [doc = "`read()` method returns [wdly_dq_bitslip::R](wdly_dq_bitslip::R) reader structure"]
impl crate :: Readable for WDLY_DQ_BITSLIP { } # [doc = "`write(|w| ..)` method takes [wdly_dq_bitslip::W](wdly_dq_bitslip::W) writer structure"]
impl crate :: Writable for WDLY_DQ_BITSLIP { } # [doc = ""]
pub mod wdly_dq_bitslip { # [doc = "Reader of register WDLY_DQ_BITSLIP"]
pub type R = crate :: R < u32 , super :: WDLY_DQ_BITSLIP > ; # [doc = "Writer for register WDLY_DQ_BITSLIP"]
pub type W = crate :: W < u32 , super :: WDLY_DQ_BITSLIP > ; # [doc = "Register WDLY_DQ_BITSLIP `reset()`'s with value 0"]
impl crate :: ResetValue for super :: WDLY_DQ_BITSLIP { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `wdly_dq_bitslip`"]
pub type WDLY_DQ_BITSLIP_R = crate :: R < bool , bool > ; # [doc = "Write proxy for field `wdly_dq_bitslip`"]
pub struct WDLY_DQ_BITSLIP_W < 'a > { w : & 'a mut W , } impl < 'a > WDLY_DQ_BITSLIP_W < 'a > { # [doc = r"Sets the field bit"]
# [inline (always)]
pub fn set_bit (self) -> & 'a mut W { self . bit (true) } # [doc = r"Clears the field bit"]
# [inline (always)]
pub fn clear_bit (self) -> & 'a mut W { self . bit (false) } # [doc = r"Writes raw bits to the field"]
...
pub fn bit (self , value : bool) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x01) | ((value as u32) & 0x01) ; self . w } } impl R { # [doc = "Bit 0"]
# [inline (always)]
pub fn wdly_dq_bitslip (& self) -> WDLY_DQ_BITSLIP_R { WDLY_DQ_BITSLIP_R :: new ((self . bits & 0x01) != 0) } } impl W { # [doc = "Bit 0"]
# [inline (always)]
pub fn wdly_dq_bitslip (& mut self) -> WDLY_DQ_BITSLIP_W { WDLY_DQ_BITSLIP_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rdphase](rdphase) module"]
pub type RDPHASE = crate :: Reg < u32 , _RDPHASE > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _RDPHASE ; # [doc = "`read()` method returns [rdphase::R](rdphase::R) reader structure"]
impl crate :: Readable for RDPHASE { } # [doc = "`write(|w| ..)` method takes [rdphase::W](rdphase::W) writer structure"]
impl crate :: Writable for RDPHASE { } # [doc = ""]
pub mod rdphase { # [doc = "Reader of register RDPHASE"]
pub type R = crate :: R < u32 , super :: RDPHASE > ; # [doc = "Writer for register RDPHASE"]
pub type W = crate :: W < u32 , super :: RDPHASE > ; # [doc = "Register RDPHASE `reset()`'s with value 0x02"]
impl crate :: ResetValue for super :: RDPHASE { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0x02 } } # [doc = "Reader of field `rdphase`"]
pub type RDPHASE_R = crate :: R < u8 , u8 > ; # [doc = "Write proxy for field `rdphase`"]
pub struct RDPHASE_W < 'a > { w : & 'a mut W , } impl < 'a > RDPHASE_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u8) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x03) | ((value as u32) & 0x03) ; self . w } } impl R { # [doc = "Bits 0:1"]
# [inline (always)]
pub fn rdphase (& self) -> RDPHASE_R { RDPHASE_R :: new ((self . bits & 0x03) as u8) } } impl W { # [doc = "Bits 0:1"]
# [inline (always)]
pub fn rdphase (& mut self) -> RDPHASE_W { RDPHASE_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [wrphase](wrphase) module"]
pub type WRPHASE = crate :: Reg < u32 , _WRPHASE > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _WRPHASE ; # [doc = "`read()` method returns [wrphase::R](wrphase::R) reader structure"]
impl crate :: Readable for WRPHASE { } # [doc = "`write(|w| ..)` method takes [wrphase::W](wrphase::W) writer structure"]
impl crate :: Writable for WRPHASE { } # [doc = ""]
pub mod wrphase { # [doc = "Reader of register WRPHASE"]
pub type R = crate :: R < u32 , super :: WRPHASE > ; # [doc = "Writer for register WRPHASE"]
pub type W = crate :: W < u32 , super :: WRPHASE > ; # [doc = "Register WRPHASE `reset()`'s with value 0x03"]
impl crate :: ResetValue for super :: WRPHASE { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0x03 } } # [doc = "Reader of field `wrphase`"]
pub type WRPHASE_R = crate :: R < u8 , u8 > ; # [doc = "Write proxy for field `wrphase`"]
pub struct WRPHASE_W < 'a > { w : & 'a mut W , } impl < 'a > WRPHASE_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u8) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x03) | ((value as u32) & 0x03) ; self . w } } impl R { # [doc = "Bits 0:1"]
# [inline (always)]
pub fn wrphase (& self) -> WRPHASE_R { WRPHASE_R :: new ((self . bits & 0x03) as u8) } } impl W { # [doc = "Bits 0:1"]
# [inline (always)]
pub fn wrphase (& mut self) -> WRPHASE_W { WRPHASE_W { w : self } } } } } # [doc = "IDENTIFIER_MEM"]
...
# [inline (always)]
pub const fn ptr () -> * const identifier_mem :: RegisterBlock { 0xf000_1000 as * const _ } } impl Deref for IDENTIFIER_MEM { type Target = identifier_mem :: RegisterBlock ; # [inline (always)]
fn deref (& self) -> & Self :: Target { unsafe { & * IDENTIFIER_MEM :: ptr () } } } # [doc = "IDENTIFIER_MEM"]
pub mod identifier_mem { # [doc = r"Register block"]
# [repr (C)]
pub struct RegisterBlock { # [doc = "0x00 - 8 x 42-bit memory"]
pub identifier_mem : IDENTIFIER_MEM , } # [doc = "8 x 42-bit memory\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [identifier_mem](identifier_mem) module"]
...
impl crate :: Writable for IDENTIFIER_MEM { } # [doc = "8 x 42-bit memory"]
...
# [inline (always)]
pub const fn ptr () -> * const leds :: RegisterBlock { 0xf000_1800 as * const _ } } impl Deref for LEDS { type Target = leds :: RegisterBlock ; # [inline (always)]
...
# [inline (always)]
pub fn out (& mut self) -> OUT_W { OUT_W { w : self } } } } } # [doc = "SDRAM"]
...
# [inline (always)]
pub const fn ptr () -> * const sdram :: RegisterBlock { 0xf000_2000 as * const _ } } impl Deref for SDRAM { type Target = sdram :: RegisterBlock ; # [inline (always)]
...
pub dfii_pi0_rddata : DFII_PI0_RDDATA , # [doc = "0x1c - "]
pub dfii_pi1_command : DFII_PI1_COMMAND , # [doc = "0x20 - "]
pub dfii_pi1_command_issue : DFII_PI1_COMMAND_ISSUE , # [doc = "0x24 - "]
pub dfii_pi1_address : DFII_PI1_ADDRESS , # [doc = "0x28 - "]
pub dfii_pi1_baddress : DFII_PI1_BADDRESS , # [doc = "0x2c - "]
pub dfii_pi1_wrdata : DFII_PI1_WRDATA , # [doc = "0x30 - "]
pub dfii_pi1_rddata : DFII_PI1_RDDATA , # [doc = "0x34 - "]
pub dfii_pi2_command : DFII_PI2_COMMAND , # [doc = "0x38 - "]
pub dfii_pi2_command_issue : DFII_PI2_COMMAND_ISSUE , # [doc = "0x3c - "]
pub dfii_pi2_address : DFII_PI2_ADDRESS , # [doc = "0x40 - "]
pub dfii_pi2_baddress : DFII_PI2_BADDRESS , # [doc = "0x44 - "]
pub dfii_pi2_wrdata : DFII_PI2_WRDATA , # [doc = "0x48 - "]
pub dfii_pi2_rddata : DFII_PI2_RDDATA , # [doc = "0x4c - "]
pub dfii_pi3_command : DFII_PI3_COMMAND , # [doc = "0x50 - "]
pub dfii_pi3_command_issue : DFII_PI3_COMMAND_ISSUE , # [doc = "0x54 - "]
pub dfii_pi3_address : DFII_PI3_ADDRESS , # [doc = "0x58 - "]
pub dfii_pi3_baddress : DFII_PI3_BADDRESS , # [doc = "0x5c - "]
pub dfii_pi3_wrdata : DFII_PI3_WRDATA , # [doc = "0x60 - "]
pub dfii_pi3_rddata : DFII_PI3_RDDATA , } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfii_control](dfii_control) module"]
...
# [inline (always)]
pub unsafe fn bits (self , value : u16) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x3fff) | ((value as u32) & 0x3fff) ; self . w } } impl R { # [doc = "Bits 0:13"]
# [inline (always)]
pub fn dfii_pi0_address (& self) -> DFII_PI0_ADDRESS_R { DFII_PI0_ADDRESS_R :: new ((self . bits & 0x3fff) as u16) } } impl W { # [doc = "Bits 0:13"]
# [inline (always)]
...
# [inline (always)]
pub fn dfii_pi0_baddress (& self) -> DFII_PI0_BADDRESS_R { DFII_PI0_BADDRESS_R :: new ((self . bits & 0x07) as u8) } } impl W { # [doc = "Bits 0:2"]
# [inline (always)]
...
# [inline (always)]
pub fn dfii_pi0_rddata (& mut self) -> DFII_PI0_RDDATA_W { DFII_PI0_RDDATA_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfii_pi1_command](dfii_pi1_command) module"]
pub type DFII_PI1_COMMAND = crate :: Reg < u32 , _DFII_PI1_COMMAND > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _DFII_PI1_COMMAND ; # [doc = "`read()` method returns [dfii_pi1_command::R](dfii_pi1_command::R) reader structure"]
impl crate :: Readable for DFII_PI1_COMMAND { } # [doc = "`write(|w| ..)` method takes [dfii_pi1_command::W](dfii_pi1_command::W) writer structure"]
impl crate :: Writable for DFII_PI1_COMMAND { } # [doc = ""]
pub mod dfii_pi1_command { # [doc = "Reader of register DFII_PI1_COMMAND"]
pub type R = crate :: R < u32 , super :: DFII_PI1_COMMAND > ; # [doc = "Writer for register DFII_PI1_COMMAND"]
pub type W = crate :: W < u32 , super :: DFII_PI1_COMMAND > ; # [doc = "Register DFII_PI1_COMMAND `reset()`'s with value 0"]
impl crate :: ResetValue for super :: DFII_PI1_COMMAND { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `dfii_pi1_command`"]
pub type DFII_PI1_COMMAND_R = crate :: R < u8 , u8 > ; # [doc = "Write proxy for field `dfii_pi1_command`"]
pub struct DFII_PI1_COMMAND_W < 'a > { w : & 'a mut W , } impl < 'a > DFII_PI1_COMMAND_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u8) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x3f) | ((value as u32) & 0x3f) ; self . w } } impl R { # [doc = "Bits 0:5"]
# [inline (always)]
pub fn dfii_pi1_command (& self) -> DFII_PI1_COMMAND_R { DFII_PI1_COMMAND_R :: new ((self . bits & 0x3f) as u8) } } impl W { # [doc = "Bits 0:5"]
# [inline (always)]
pub fn dfii_pi1_command (& mut self) -> DFII_PI1_COMMAND_W { DFII_PI1_COMMAND_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfii_pi1_command_issue](dfii_pi1_command_issue) module"]
pub type DFII_PI1_COMMAND_ISSUE = crate :: Reg < u32 , _DFII_PI1_COMMAND_ISSUE > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _DFII_PI1_COMMAND_ISSUE ; # [doc = "`read()` method returns [dfii_pi1_command_issue::R](dfii_pi1_command_issue::R) reader structure"]
impl crate :: Readable for DFII_PI1_COMMAND_ISSUE { } # [doc = "`write(|w| ..)` method takes [dfii_pi1_command_issue::W](dfii_pi1_command_issue::W) writer structure"]
impl crate :: Writable for DFII_PI1_COMMAND_ISSUE { } # [doc = ""]
pub mod dfii_pi1_command_issue { # [doc = "Reader of register DFII_PI1_COMMAND_ISSUE"]
pub type R = crate :: R < u32 , super :: DFII_PI1_COMMAND_ISSUE > ; # [doc = "Writer for register DFII_PI1_COMMAND_ISSUE"]
pub type W = crate :: W < u32 , super :: DFII_PI1_COMMAND_ISSUE > ; # [doc = "Register DFII_PI1_COMMAND_ISSUE `reset()`'s with value 0"]
impl crate :: ResetValue for super :: DFII_PI1_COMMAND_ISSUE { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `dfii_pi1_command_issue`"]
pub type DFII_PI1_COMMAND_ISSUE_R = crate :: R < bool , bool > ; # [doc = "Write proxy for field `dfii_pi1_command_issue`"]
pub struct DFII_PI1_COMMAND_ISSUE_W < 'a > { w : & 'a mut W , } impl < 'a > DFII_PI1_COMMAND_ISSUE_W < 'a > { # [doc = r"Sets the field bit"]
# [inline (always)]
pub fn set_bit (self) -> & 'a mut W { self . bit (true) } # [doc = r"Clears the field bit"]
# [inline (always)]
pub fn clear_bit (self) -> & 'a mut W { self . bit (false) } # [doc = r"Writes raw bits to the field"]
...
pub fn bit (self , value : bool) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x01) | ((value as u32) & 0x01) ; self . w } } impl R { # [doc = "Bit 0"]
# [inline (always)]
pub fn dfii_pi1_command_issue (& self) -> DFII_PI1_COMMAND_ISSUE_R { DFII_PI1_COMMAND_ISSUE_R :: new ((self . bits & 0x01) != 0) } } impl W { # [doc = "Bit 0"]
# [inline (always)]
pub fn dfii_pi1_command_issue (& mut self) -> DFII_PI1_COMMAND_ISSUE_W { DFII_PI1_COMMAND_ISSUE_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfii_pi1_address](dfii_pi1_address) module"]
pub type DFII_PI1_ADDRESS = crate :: Reg < u32 , _DFII_PI1_ADDRESS > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _DFII_PI1_ADDRESS ; # [doc = "`read()` method returns [dfii_pi1_address::R](dfii_pi1_address::R) reader structure"]
impl crate :: Readable for DFII_PI1_ADDRESS { } # [doc = "`write(|w| ..)` method takes [dfii_pi1_address::W](dfii_pi1_address::W) writer structure"]
impl crate :: Writable for DFII_PI1_ADDRESS { } # [doc = ""]
pub mod dfii_pi1_address { # [doc = "Reader of register DFII_PI1_ADDRESS"]
pub type R = crate :: R < u32 , super :: DFII_PI1_ADDRESS > ; # [doc = "Writer for register DFII_PI1_ADDRESS"]
pub type W = crate :: W < u32 , super :: DFII_PI1_ADDRESS > ; # [doc = "Register DFII_PI1_ADDRESS `reset()`'s with value 0"]
impl crate :: ResetValue for super :: DFII_PI1_ADDRESS { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `dfii_pi1_address`"]
pub type DFII_PI1_ADDRESS_R = crate :: R < u16 , u16 > ; # [doc = "Write proxy for field `dfii_pi1_address`"]
pub struct DFII_PI1_ADDRESS_W < 'a > { w : & 'a mut W , } impl < 'a > DFII_PI1_ADDRESS_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u16) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x3fff) | ((value as u32) & 0x3fff) ; self . w } } impl R { # [doc = "Bits 0:13"]
# [inline (always)]
pub fn dfii_pi1_address (& self) -> DFII_PI1_ADDRESS_R { DFII_PI1_ADDRESS_R :: new ((self . bits & 0x3fff) as u16) } } impl W { # [doc = "Bits 0:13"]
# [inline (always)]
pub fn dfii_pi1_address (& mut self) -> DFII_PI1_ADDRESS_W { DFII_PI1_ADDRESS_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfii_pi1_baddress](dfii_pi1_baddress) module"]
pub type DFII_PI1_BADDRESS = crate :: Reg < u32 , _DFII_PI1_BADDRESS > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _DFII_PI1_BADDRESS ; # [doc = "`read()` method returns [dfii_pi1_baddress::R](dfii_pi1_baddress::R) reader structure"]
impl crate :: Readable for DFII_PI1_BADDRESS { } # [doc = "`write(|w| ..)` method takes [dfii_pi1_baddress::W](dfii_pi1_baddress::W) writer structure"]
impl crate :: Writable for DFII_PI1_BADDRESS { } # [doc = ""]
pub mod dfii_pi1_baddress { # [doc = "Reader of register DFII_PI1_BADDRESS"]
pub type R = crate :: R < u32 , super :: DFII_PI1_BADDRESS > ; # [doc = "Writer for register DFII_PI1_BADDRESS"]
pub type W = crate :: W < u32 , super :: DFII_PI1_BADDRESS > ; # [doc = "Register DFII_PI1_BADDRESS `reset()`'s with value 0"]
impl crate :: ResetValue for super :: DFII_PI1_BADDRESS { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `dfii_pi1_baddress`"]
pub type DFII_PI1_BADDRESS_R = crate :: R < u8 , u8 > ; # [doc = "Write proxy for field `dfii_pi1_baddress`"]
pub struct DFII_PI1_BADDRESS_W < 'a > { w : & 'a mut W , } impl < 'a > DFII_PI1_BADDRESS_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u8) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x07) | ((value as u32) & 0x07) ; self . w } } impl R { # [doc = "Bits 0:2"]
# [inline (always)]
pub fn dfii_pi1_baddress (& self) -> DFII_PI1_BADDRESS_R { DFII_PI1_BADDRESS_R :: new ((self . bits & 0x07) as u8) } } impl W { # [doc = "Bits 0:2"]
# [inline (always)]
pub fn dfii_pi1_baddress (& mut self) -> DFII_PI1_BADDRESS_W { DFII_PI1_BADDRESS_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfii_pi1_wrdata](dfii_pi1_wrdata) module"]
pub type DFII_PI1_WRDATA = crate :: Reg < u32 , _DFII_PI1_WRDATA > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _DFII_PI1_WRDATA ; # [doc = "`read()` method returns [dfii_pi1_wrdata::R](dfii_pi1_wrdata::R) reader structure"]
impl crate :: Readable for DFII_PI1_WRDATA { } # [doc = "`write(|w| ..)` method takes [dfii_pi1_wrdata::W](dfii_pi1_wrdata::W) writer structure"]
impl crate :: Writable for DFII_PI1_WRDATA { } # [doc = ""]
pub mod dfii_pi1_wrdata { # [doc = "Reader of register DFII_PI1_WRDATA"]
pub type R = crate :: R < u32 , super :: DFII_PI1_WRDATA > ; # [doc = "Writer for register DFII_PI1_WRDATA"]
pub type W = crate :: W < u32 , super :: DFII_PI1_WRDATA > ; # [doc = "Register DFII_PI1_WRDATA `reset()`'s with value 0"]
impl crate :: ResetValue for super :: DFII_PI1_WRDATA { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `dfii_pi1_wrdata`"]
pub type DFII_PI1_WRDATA_R = crate :: R < u32 , u32 > ; # [doc = "Write proxy for field `dfii_pi1_wrdata`"]
pub struct DFII_PI1_WRDATA_W < 'a > { w : & 'a mut W , } impl < 'a > DFII_PI1_WRDATA_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u32) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0xffff_ffff) | ((value as u32) & 0xffff_ffff) ; self . w } } impl R { # [doc = "Bits 0:31"]
# [inline (always)]
pub fn dfii_pi1_wrdata (& self) -> DFII_PI1_WRDATA_R { DFII_PI1_WRDATA_R :: new ((self . bits & 0xffff_ffff) as u32) } } impl W { # [doc = "Bits 0:31"]
# [inline (always)]
pub fn dfii_pi1_wrdata (& mut self) -> DFII_PI1_WRDATA_W { DFII_PI1_WRDATA_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfii_pi1_rddata](dfii_pi1_rddata) module"]
pub type DFII_PI1_RDDATA = crate :: Reg < u32 , _DFII_PI1_RDDATA > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _DFII_PI1_RDDATA ; # [doc = "`read()` method returns [dfii_pi1_rddata::R](dfii_pi1_rddata::R) reader structure"]
impl crate :: Readable for DFII_PI1_RDDATA { } # [doc = "`write(|w| ..)` method takes [dfii_pi1_rddata::W](dfii_pi1_rddata::W) writer structure"]
impl crate :: Writable for DFII_PI1_RDDATA { } # [doc = ""]
pub mod dfii_pi1_rddata { # [doc = "Reader of register DFII_PI1_RDDATA"]
pub type R = crate :: R < u32 , super :: DFII_PI1_RDDATA > ; # [doc = "Writer for register DFII_PI1_RDDATA"]
pub type W = crate :: W < u32 , super :: DFII_PI1_RDDATA > ; # [doc = "Register DFII_PI1_RDDATA `reset()`'s with value 0"]
impl crate :: ResetValue for super :: DFII_PI1_RDDATA { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `dfii_pi1_rddata`"]
pub type DFII_PI1_RDDATA_R = crate :: R < u32 , u32 > ; # [doc = "Write proxy for field `dfii_pi1_rddata`"]
pub struct DFII_PI1_RDDATA_W < 'a > { w : & 'a mut W , } impl < 'a > DFII_PI1_RDDATA_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u32) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0xffff_ffff) | ((value as u32) & 0xffff_ffff) ; self . w } } impl R { # [doc = "Bits 0:31"]
# [inline (always)]
pub fn dfii_pi1_rddata (& self) -> DFII_PI1_RDDATA_R { DFII_PI1_RDDATA_R :: new ((self . bits & 0xffff_ffff) as u32) } } impl W { # [doc = "Bits 0:31"]
# [inline (always)]
pub fn dfii_pi1_rddata (& mut self) -> DFII_PI1_RDDATA_W { DFII_PI1_RDDATA_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfii_pi2_command](dfii_pi2_command) module"]
pub type DFII_PI2_COMMAND = crate :: Reg < u32 , _DFII_PI2_COMMAND > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _DFII_PI2_COMMAND ; # [doc = "`read()` method returns [dfii_pi2_command::R](dfii_pi2_command::R) reader structure"]
impl crate :: Readable for DFII_PI2_COMMAND { } # [doc = "`write(|w| ..)` method takes [dfii_pi2_command::W](dfii_pi2_command::W) writer structure"]
impl crate :: Writable for DFII_PI2_COMMAND { } # [doc = ""]
pub mod dfii_pi2_command { # [doc = "Reader of register DFII_PI2_COMMAND"]
pub type R = crate :: R < u32 , super :: DFII_PI2_COMMAND > ; # [doc = "Writer for register DFII_PI2_COMMAND"]
pub type W = crate :: W < u32 , super :: DFII_PI2_COMMAND > ; # [doc = "Register DFII_PI2_COMMAND `reset()`'s with value 0"]
impl crate :: ResetValue for super :: DFII_PI2_COMMAND { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `dfii_pi2_command`"]
pub type DFII_PI2_COMMAND_R = crate :: R < u8 , u8 > ; # [doc = "Write proxy for field `dfii_pi2_command`"]
pub struct DFII_PI2_COMMAND_W < 'a > { w : & 'a mut W , } impl < 'a > DFII_PI2_COMMAND_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u8) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x3f) | ((value as u32) & 0x3f) ; self . w } } impl R { # [doc = "Bits 0:5"]
# [inline (always)]
pub fn dfii_pi2_command (& self) -> DFII_PI2_COMMAND_R { DFII_PI2_COMMAND_R :: new ((self . bits & 0x3f) as u8) } } impl W { # [doc = "Bits 0:5"]
# [inline (always)]
pub fn dfii_pi2_command (& mut self) -> DFII_PI2_COMMAND_W { DFII_PI2_COMMAND_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfii_pi2_command_issue](dfii_pi2_command_issue) module"]
pub type DFII_PI2_COMMAND_ISSUE = crate :: Reg < u32 , _DFII_PI2_COMMAND_ISSUE > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _DFII_PI2_COMMAND_ISSUE ; # [doc = "`read()` method returns [dfii_pi2_command_issue::R](dfii_pi2_command_issue::R) reader structure"]
impl crate :: Readable for DFII_PI2_COMMAND_ISSUE { } # [doc = "`write(|w| ..)` method takes [dfii_pi2_command_issue::W](dfii_pi2_command_issue::W) writer structure"]
impl crate :: Writable for DFII_PI2_COMMAND_ISSUE { } # [doc = ""]
pub mod dfii_pi2_command_issue { # [doc = "Reader of register DFII_PI2_COMMAND_ISSUE"]
pub type R = crate :: R < u32 , super :: DFII_PI2_COMMAND_ISSUE > ; # [doc = "Writer for register DFII_PI2_COMMAND_ISSUE"]
pub type W = crate :: W < u32 , super :: DFII_PI2_COMMAND_ISSUE > ; # [doc = "Register DFII_PI2_COMMAND_ISSUE `reset()`'s with value 0"]
impl crate :: ResetValue for super :: DFII_PI2_COMMAND_ISSUE { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `dfii_pi2_command_issue`"]
pub type DFII_PI2_COMMAND_ISSUE_R = crate :: R < bool , bool > ; # [doc = "Write proxy for field `dfii_pi2_command_issue`"]
pub struct DFII_PI2_COMMAND_ISSUE_W < 'a > { w : & 'a mut W , } impl < 'a > DFII_PI2_COMMAND_ISSUE_W < 'a > { # [doc = r"Sets the field bit"]
# [inline (always)]
pub fn set_bit (self) -> & 'a mut W { self . bit (true) } # [doc = r"Clears the field bit"]
# [inline (always)]
pub fn clear_bit (self) -> & 'a mut W { self . bit (false) } # [doc = r"Writes raw bits to the field"]
...
pub fn bit (self , value : bool) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x01) | ((value as u32) & 0x01) ; self . w } } impl R { # [doc = "Bit 0"]
# [inline (always)]
pub fn dfii_pi2_command_issue (& self) -> DFII_PI2_COMMAND_ISSUE_R { DFII_PI2_COMMAND_ISSUE_R :: new ((self . bits & 0x01) != 0) } } impl W { # [doc = "Bit 0"]
# [inline (always)]
pub fn dfii_pi2_command_issue (& mut self) -> DFII_PI2_COMMAND_ISSUE_W { DFII_PI2_COMMAND_ISSUE_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfii_pi2_address](dfii_pi2_address) module"]
pub type DFII_PI2_ADDRESS = crate :: Reg < u32 , _DFII_PI2_ADDRESS > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _DFII_PI2_ADDRESS ; # [doc = "`read()` method returns [dfii_pi2_address::R](dfii_pi2_address::R) reader structure"]
impl crate :: Readable for DFII_PI2_ADDRESS { } # [doc = "`write(|w| ..)` method takes [dfii_pi2_address::W](dfii_pi2_address::W) writer structure"]
impl crate :: Writable for DFII_PI2_ADDRESS { } # [doc = ""]
pub mod dfii_pi2_address { # [doc = "Reader of register DFII_PI2_ADDRESS"]
pub type R = crate :: R < u32 , super :: DFII_PI2_ADDRESS > ; # [doc = "Writer for register DFII_PI2_ADDRESS"]
pub type W = crate :: W < u32 , super :: DFII_PI2_ADDRESS > ; # [doc = "Register DFII_PI2_ADDRESS `reset()`'s with value 0"]
impl crate :: ResetValue for super :: DFII_PI2_ADDRESS { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `dfii_pi2_address`"]
pub type DFII_PI2_ADDRESS_R = crate :: R < u16 , u16 > ; # [doc = "Write proxy for field `dfii_pi2_address`"]
pub struct DFII_PI2_ADDRESS_W < 'a > { w : & 'a mut W , } impl < 'a > DFII_PI2_ADDRESS_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u16) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x3fff) | ((value as u32) & 0x3fff) ; self . w } } impl R { # [doc = "Bits 0:13"]
# [inline (always)]
pub fn dfii_pi2_address (& self) -> DFII_PI2_ADDRESS_R { DFII_PI2_ADDRESS_R :: new ((self . bits & 0x3fff) as u16) } } impl W { # [doc = "Bits 0:13"]
# [inline (always)]
pub fn dfii_pi2_address (& mut self) -> DFII_PI2_ADDRESS_W { DFII_PI2_ADDRESS_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfii_pi2_baddress](dfii_pi2_baddress) module"]
pub type DFII_PI2_BADDRESS = crate :: Reg < u32 , _DFII_PI2_BADDRESS > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _DFII_PI2_BADDRESS ; # [doc = "`read()` method returns [dfii_pi2_baddress::R](dfii_pi2_baddress::R) reader structure"]
impl crate :: Readable for DFII_PI2_BADDRESS { } # [doc = "`write(|w| ..)` method takes [dfii_pi2_baddress::W](dfii_pi2_baddress::W) writer structure"]
impl crate :: Writable for DFII_PI2_BADDRESS { } # [doc = ""]
pub mod dfii_pi2_baddress { # [doc = "Reader of register DFII_PI2_BADDRESS"]
pub type R = crate :: R < u32 , super :: DFII_PI2_BADDRESS > ; # [doc = "Writer for register DFII_PI2_BADDRESS"]
pub type W = crate :: W < u32 , super :: DFII_PI2_BADDRESS > ; # [doc = "Register DFII_PI2_BADDRESS `reset()`'s with value 0"]
impl crate :: ResetValue for super :: DFII_PI2_BADDRESS { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `dfii_pi2_baddress`"]
pub type DFII_PI2_BADDRESS_R = crate :: R < u8 , u8 > ; # [doc = "Write proxy for field `dfii_pi2_baddress`"]
pub struct DFII_PI2_BADDRESS_W < 'a > { w : & 'a mut W , } impl < 'a > DFII_PI2_BADDRESS_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u8) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x07) | ((value as u32) & 0x07) ; self . w } } impl R { # [doc = "Bits 0:2"]
# [inline (always)]
pub fn dfii_pi2_baddress (& self) -> DFII_PI2_BADDRESS_R { DFII_PI2_BADDRESS_R :: new ((self . bits & 0x07) as u8) } } impl W { # [doc = "Bits 0:2"]
# [inline (always)]
pub fn dfii_pi2_baddress (& mut self) -> DFII_PI2_BADDRESS_W { DFII_PI2_BADDRESS_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfii_pi2_wrdata](dfii_pi2_wrdata) module"]
pub type DFII_PI2_WRDATA = crate :: Reg < u32 , _DFII_PI2_WRDATA > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _DFII_PI2_WRDATA ; # [doc = "`read()` method returns [dfii_pi2_wrdata::R](dfii_pi2_wrdata::R) reader structure"]
impl crate :: Readable for DFII_PI2_WRDATA { } # [doc = "`write(|w| ..)` method takes [dfii_pi2_wrdata::W](dfii_pi2_wrdata::W) writer structure"]
impl crate :: Writable for DFII_PI2_WRDATA { } # [doc = ""]
pub mod dfii_pi2_wrdata { # [doc = "Reader of register DFII_PI2_WRDATA"]
pub type R = crate :: R < u32 , super :: DFII_PI2_WRDATA > ; # [doc = "Writer for register DFII_PI2_WRDATA"]
pub type W = crate :: W < u32 , super :: DFII_PI2_WRDATA > ; # [doc = "Register DFII_PI2_WRDATA `reset()`'s with value 0"]
impl crate :: ResetValue for super :: DFII_PI2_WRDATA { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `dfii_pi2_wrdata`"]
pub type DFII_PI2_WRDATA_R = crate :: R < u32 , u32 > ; # [doc = "Write proxy for field `dfii_pi2_wrdata`"]
pub struct DFII_PI2_WRDATA_W < 'a > { w : & 'a mut W , } impl < 'a > DFII_PI2_WRDATA_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u32) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0xffff_ffff) | ((value as u32) & 0xffff_ffff) ; self . w } } impl R { # [doc = "Bits 0:31"]
# [inline (always)]
pub fn dfii_pi2_wrdata (& self) -> DFII_PI2_WRDATA_R { DFII_PI2_WRDATA_R :: new ((self . bits & 0xffff_ffff) as u32) } } impl W { # [doc = "Bits 0:31"]
# [inline (always)]
pub fn dfii_pi2_wrdata (& mut self) -> DFII_PI2_WRDATA_W { DFII_PI2_WRDATA_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfii_pi2_rddata](dfii_pi2_rddata) module"]
pub type DFII_PI2_RDDATA = crate :: Reg < u32 , _DFII_PI2_RDDATA > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _DFII_PI2_RDDATA ; # [doc = "`read()` method returns [dfii_pi2_rddata::R](dfii_pi2_rddata::R) reader structure"]
impl crate :: Readable for DFII_PI2_RDDATA { } # [doc = "`write(|w| ..)` method takes [dfii_pi2_rddata::W](dfii_pi2_rddata::W) writer structure"]
impl crate :: Writable for DFII_PI2_RDDATA { } # [doc = ""]
pub mod dfii_pi2_rddata { # [doc = "Reader of register DFII_PI2_RDDATA"]
pub type R = crate :: R < u32 , super :: DFII_PI2_RDDATA > ; # [doc = "Writer for register DFII_PI2_RDDATA"]
pub type W = crate :: W < u32 , super :: DFII_PI2_RDDATA > ; # [doc = "Register DFII_PI2_RDDATA `reset()`'s with value 0"]
impl crate :: ResetValue for super :: DFII_PI2_RDDATA { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `dfii_pi2_rddata`"]
pub type DFII_PI2_RDDATA_R = crate :: R < u32 , u32 > ; # [doc = "Write proxy for field `dfii_pi2_rddata`"]
pub struct DFII_PI2_RDDATA_W < 'a > { w : & 'a mut W , } impl < 'a > DFII_PI2_RDDATA_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u32) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0xffff_ffff) | ((value as u32) & 0xffff_ffff) ; self . w } } impl R { # [doc = "Bits 0:31"]
# [inline (always)]
pub fn dfii_pi2_rddata (& self) -> DFII_PI2_RDDATA_R { DFII_PI2_RDDATA_R :: new ((self . bits & 0xffff_ffff) as u32) } } impl W { # [doc = "Bits 0:31"]
# [inline (always)]
pub fn dfii_pi2_rddata (& mut self) -> DFII_PI2_RDDATA_W { DFII_PI2_RDDATA_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfii_pi3_command](dfii_pi3_command) module"]
pub type DFII_PI3_COMMAND = crate :: Reg < u32 , _DFII_PI3_COMMAND > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _DFII_PI3_COMMAND ; # [doc = "`read()` method returns [dfii_pi3_command::R](dfii_pi3_command::R) reader structure"]
impl crate :: Readable for DFII_PI3_COMMAND { } # [doc = "`write(|w| ..)` method takes [dfii_pi3_command::W](dfii_pi3_command::W) writer structure"]
impl crate :: Writable for DFII_PI3_COMMAND { } # [doc = ""]
pub mod dfii_pi3_command { # [doc = "Reader of register DFII_PI3_COMMAND"]
pub type R = crate :: R < u32 , super :: DFII_PI3_COMMAND > ; # [doc = "Writer for register DFII_PI3_COMMAND"]
pub type W = crate :: W < u32 , super :: DFII_PI3_COMMAND > ; # [doc = "Register DFII_PI3_COMMAND `reset()`'s with value 0"]
impl crate :: ResetValue for super :: DFII_PI3_COMMAND { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `dfii_pi3_command`"]
pub type DFII_PI3_COMMAND_R = crate :: R < u8 , u8 > ; # [doc = "Write proxy for field `dfii_pi3_command`"]
pub struct DFII_PI3_COMMAND_W < 'a > { w : & 'a mut W , } impl < 'a > DFII_PI3_COMMAND_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u8) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x3f) | ((value as u32) & 0x3f) ; self . w } } impl R { # [doc = "Bits 0:5"]
# [inline (always)]
pub fn dfii_pi3_command (& self) -> DFII_PI3_COMMAND_R { DFII_PI3_COMMAND_R :: new ((self . bits & 0x3f) as u8) } } impl W { # [doc = "Bits 0:5"]
# [inline (always)]
pub fn dfii_pi3_command (& mut self) -> DFII_PI3_COMMAND_W { DFII_PI3_COMMAND_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfii_pi3_command_issue](dfii_pi3_command_issue) module"]
pub type DFII_PI3_COMMAND_ISSUE = crate :: Reg < u32 , _DFII_PI3_COMMAND_ISSUE > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _DFII_PI3_COMMAND_ISSUE ; # [doc = "`read()` method returns [dfii_pi3_command_issue::R](dfii_pi3_command_issue::R) reader structure"]
impl crate :: Readable for DFII_PI3_COMMAND_ISSUE { } # [doc = "`write(|w| ..)` method takes [dfii_pi3_command_issue::W](dfii_pi3_command_issue::W) writer structure"]
impl crate :: Writable for DFII_PI3_COMMAND_ISSUE { } # [doc = ""]
pub mod dfii_pi3_command_issue { # [doc = "Reader of register DFII_PI3_COMMAND_ISSUE"]
pub type R = crate :: R < u32 , super :: DFII_PI3_COMMAND_ISSUE > ; # [doc = "Writer for register DFII_PI3_COMMAND_ISSUE"]
pub type W = crate :: W < u32 , super :: DFII_PI3_COMMAND_ISSUE > ; # [doc = "Register DFII_PI3_COMMAND_ISSUE `reset()`'s with value 0"]
impl crate :: ResetValue for super :: DFII_PI3_COMMAND_ISSUE { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `dfii_pi3_command_issue`"]
pub type DFII_PI3_COMMAND_ISSUE_R = crate :: R < bool , bool > ; # [doc = "Write proxy for field `dfii_pi3_command_issue`"]
pub struct DFII_PI3_COMMAND_ISSUE_W < 'a > { w : & 'a mut W , } impl < 'a > DFII_PI3_COMMAND_ISSUE_W < 'a > { # [doc = r"Sets the field bit"]
# [inline (always)]
pub fn set_bit (self) -> & 'a mut W { self . bit (true) } # [doc = r"Clears the field bit"]
# [inline (always)]
pub fn clear_bit (self) -> & 'a mut W { self . bit (false) } # [doc = r"Writes raw bits to the field"]
...
pub fn bit (self , value : bool) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x01) | ((value as u32) & 0x01) ; self . w } } impl R { # [doc = "Bit 0"]
# [inline (always)]
pub fn dfii_pi3_command_issue (& self) -> DFII_PI3_COMMAND_ISSUE_R { DFII_PI3_COMMAND_ISSUE_R :: new ((self . bits & 0x01) != 0) } } impl W { # [doc = "Bit 0"]
# [inline (always)]
pub fn dfii_pi3_command_issue (& mut self) -> DFII_PI3_COMMAND_ISSUE_W { DFII_PI3_COMMAND_ISSUE_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfii_pi3_address](dfii_pi3_address) module"]
pub type DFII_PI3_ADDRESS = crate :: Reg < u32 , _DFII_PI3_ADDRESS > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _DFII_PI3_ADDRESS ; # [doc = "`read()` method returns [dfii_pi3_address::R](dfii_pi3_address::R) reader structure"]
impl crate :: Readable for DFII_PI3_ADDRESS { } # [doc = "`write(|w| ..)` method takes [dfii_pi3_address::W](dfii_pi3_address::W) writer structure"]
impl crate :: Writable for DFII_PI3_ADDRESS { } # [doc = ""]
pub mod dfii_pi3_address { # [doc = "Reader of register DFII_PI3_ADDRESS"]
pub type R = crate :: R < u32 , super :: DFII_PI3_ADDRESS > ; # [doc = "Writer for register DFII_PI3_ADDRESS"]
pub type W = crate :: W < u32 , super :: DFII_PI3_ADDRESS > ; # [doc = "Register DFII_PI3_ADDRESS `reset()`'s with value 0"]
impl crate :: ResetValue for super :: DFII_PI3_ADDRESS { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `dfii_pi3_address`"]
pub type DFII_PI3_ADDRESS_R = crate :: R < u16 , u16 > ; # [doc = "Write proxy for field `dfii_pi3_address`"]
pub struct DFII_PI3_ADDRESS_W < 'a > { w : & 'a mut W , } impl < 'a > DFII_PI3_ADDRESS_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u16) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x3fff) | ((value as u32) & 0x3fff) ; self . w } } impl R { # [doc = "Bits 0:13"]
# [inline (always)]
pub fn dfii_pi3_address (& self) -> DFII_PI3_ADDRESS_R { DFII_PI3_ADDRESS_R :: new ((self . bits & 0x3fff) as u16) } } impl W { # [doc = "Bits 0:13"]
# [inline (always)]
pub fn dfii_pi3_address (& mut self) -> DFII_PI3_ADDRESS_W { DFII_PI3_ADDRESS_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfii_pi3_baddress](dfii_pi3_baddress) module"]
pub type DFII_PI3_BADDRESS = crate :: Reg < u32 , _DFII_PI3_BADDRESS > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _DFII_PI3_BADDRESS ; # [doc = "`read()` method returns [dfii_pi3_baddress::R](dfii_pi3_baddress::R) reader structure"]
impl crate :: Readable for DFII_PI3_BADDRESS { } # [doc = "`write(|w| ..)` method takes [dfii_pi3_baddress::W](dfii_pi3_baddress::W) writer structure"]
impl crate :: Writable for DFII_PI3_BADDRESS { } # [doc = ""]
pub mod dfii_pi3_baddress { # [doc = "Reader of register DFII_PI3_BADDRESS"]
pub type R = crate :: R < u32 , super :: DFII_PI3_BADDRESS > ; # [doc = "Writer for register DFII_PI3_BADDRESS"]
pub type W = crate :: W < u32 , super :: DFII_PI3_BADDRESS > ; # [doc = "Register DFII_PI3_BADDRESS `reset()`'s with value 0"]
impl crate :: ResetValue for super :: DFII_PI3_BADDRESS { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `dfii_pi3_baddress`"]
pub type DFII_PI3_BADDRESS_R = crate :: R < u8 , u8 > ; # [doc = "Write proxy for field `dfii_pi3_baddress`"]
pub struct DFII_PI3_BADDRESS_W < 'a > { w : & 'a mut W , } impl < 'a > DFII_PI3_BADDRESS_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u8) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x07) | ((value as u32) & 0x07) ; self . w } } impl R { # [doc = "Bits 0:2"]
# [inline (always)]
pub fn dfii_pi3_baddress (& self) -> DFII_PI3_BADDRESS_R { DFII_PI3_BADDRESS_R :: new ((self . bits & 0x07) as u8) } } impl W { # [doc = "Bits 0:2"]
# [inline (always)]
pub fn dfii_pi3_baddress (& mut self) -> DFII_PI3_BADDRESS_W { DFII_PI3_BADDRESS_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfii_pi3_wrdata](dfii_pi3_wrdata) module"]
pub type DFII_PI3_WRDATA = crate :: Reg < u32 , _DFII_PI3_WRDATA > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _DFII_PI3_WRDATA ; # [doc = "`read()` method returns [dfii_pi3_wrdata::R](dfii_pi3_wrdata::R) reader structure"]
impl crate :: Readable for DFII_PI3_WRDATA { } # [doc = "`write(|w| ..)` method takes [dfii_pi3_wrdata::W](dfii_pi3_wrdata::W) writer structure"]
impl crate :: Writable for DFII_PI3_WRDATA { } # [doc = ""]
pub mod dfii_pi3_wrdata { # [doc = "Reader of register DFII_PI3_WRDATA"]
pub type R = crate :: R < u32 , super :: DFII_PI3_WRDATA > ; # [doc = "Writer for register DFII_PI3_WRDATA"]
pub type W = crate :: W < u32 , super :: DFII_PI3_WRDATA > ; # [doc = "Register DFII_PI3_WRDATA `reset()`'s with value 0"]
impl crate :: ResetValue for super :: DFII_PI3_WRDATA { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `dfii_pi3_wrdata`"]
pub type DFII_PI3_WRDATA_R = crate :: R < u32 , u32 > ; # [doc = "Write proxy for field `dfii_pi3_wrdata`"]
pub struct DFII_PI3_WRDATA_W < 'a > { w : & 'a mut W , } impl < 'a > DFII_PI3_WRDATA_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u32) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0xffff_ffff) | ((value as u32) & 0xffff_ffff) ; self . w } } impl R { # [doc = "Bits 0:31"]
# [inline (always)]
pub fn dfii_pi3_wrdata (& self) -> DFII_PI3_WRDATA_R { DFII_PI3_WRDATA_R :: new ((self . bits & 0xffff_ffff) as u32) } } impl W { # [doc = "Bits 0:31"]
# [inline (always)]
pub fn dfii_pi3_wrdata (& mut self) -> DFII_PI3_WRDATA_W { DFII_PI3_WRDATA_W { w : self } } } } # [doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfii_pi3_rddata](dfii_pi3_rddata) module"]
pub type DFII_PI3_RDDATA = crate :: Reg < u32 , _DFII_PI3_RDDATA > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _DFII_PI3_RDDATA ; # [doc = "`read()` method returns [dfii_pi3_rddata::R](dfii_pi3_rddata::R) reader structure"]
impl crate :: Readable for DFII_PI3_RDDATA { } # [doc = "`write(|w| ..)` method takes [dfii_pi3_rddata::W](dfii_pi3_rddata::W) writer structure"]
impl crate :: Writable for DFII_PI3_RDDATA { } # [doc = ""]
pub mod dfii_pi3_rddata { # [doc = "Reader of register DFII_PI3_RDDATA"]
pub type R = crate :: R < u32 , super :: DFII_PI3_RDDATA > ; # [doc = "Writer for register DFII_PI3_RDDATA"]
pub type W = crate :: W < u32 , super :: DFII_PI3_RDDATA > ; # [doc = "Register DFII_PI3_RDDATA `reset()`'s with value 0"]
impl crate :: ResetValue for super :: DFII_PI3_RDDATA { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `dfii_pi3_rddata`"]
pub type DFII_PI3_RDDATA_R = crate :: R < u32 , u32 > ; # [doc = "Write proxy for field `dfii_pi3_rddata`"]
pub struct DFII_PI3_RDDATA_W < 'a > { w : & 'a mut W , } impl < 'a > DFII_PI3_RDDATA_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u32) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0xffff_ffff) | ((value as u32) & 0xffff_ffff) ; self . w } } impl R { # [doc = "Bits 0:31"]
# [inline (always)]
pub fn dfii_pi3_rddata (& self) -> DFII_PI3_RDDATA_R { DFII_PI3_RDDATA_R :: new ((self . bits & 0xffff_ffff) as u32) } } impl W { # [doc = "Bits 0:31"]
# [inline (always)]
pub fn dfii_pi3_rddata (& mut self) -> DFII_PI3_RDDATA_W { DFII_PI3_RDDATA_W { w : self } } } } } # [doc = "SEVEN_SEGMENT"]
pub struct SEVEN_SEGMENT { _marker : PhantomData < * const () > } unsafe impl Send for SEVEN_SEGMENT { } impl SEVEN_SEGMENT { # [doc = r"Returns a pointer to the register block"]
# [inline (always)]
pub const fn ptr () -> * const seven_segment :: RegisterBlock { 0xf000_2800 as * const _ } } impl Deref for SEVEN_SEGMENT { type Target = seven_segment :: RegisterBlock ; # [inline (always)]
fn deref (& self) -> & Self :: Target { unsafe { & * SEVEN_SEGMENT :: ptr () } } } # [doc = "SEVEN_SEGMENT"]
pub mod seven_segment { # [doc = r"Register block"]
# [repr (C)]
pub struct RegisterBlock { # [doc = "0x00 - "]
...
impl crate :: Writable for VALUE { } # [doc = ""]
...
pub type VALUE_R = crate :: R < u16 , u16 > ; # [doc = "Write proxy for field `value`"]
...
# [inline (always)]
pub fn value (& self) -> VALUE_R { VALUE_R :: new ((self . bits & 0xffff) as u16) } } impl W { # [doc = "Bits 0:15"]
# [inline (always)]
pub fn value (& mut self) -> VALUE_W { VALUE_W { w : self } } } } } # [doc = "TIMER0"]
...
# [inline (always)]
pub const fn ptr () -> * const timer0 :: RegisterBlock { 0xf000_3000 as * const _ } } impl Deref for TIMER0 { type Target = timer0 :: RegisterBlock ; # [inline (always)]
...
# [inline (always)]
pub const fn ptr () -> * const uart :: RegisterBlock { 0xf000_3800 as * const _ } } impl Deref for UART { type Target = uart :: RegisterBlock ; # [inline (always)]
...
pub CTRL : CTRL , # [doc = "DDRPHY"]
pub DDRPHY : DDRPHY , # [doc = "IDENTIFIER_MEM"]
pub IDENTIFIER_MEM : IDENTIFIER_MEM , # [doc = "LEDS"]
pub LEDS : LEDS , # [doc = "SDRAM"]
pub SDRAM : SDRAM , # [doc = "SEVEN_SEGMENT"]
pub SEVEN_SEGMENT : SEVEN_SEGMENT , # [doc = "TIMER0"]
...
# [inline]
pub unsafe fn steal () -> Self { DEVICE_PERIPHERALS = true ; Peripherals { CTRL : CTRL { _marker : PhantomData } , DDRPHY : DDRPHY { _marker : PhantomData } , IDENTIFIER_MEM : IDENTIFIER_MEM { _marker : PhantomData } , LEDS : LEDS { _marker : PhantomData } , SDRAM : SDRAM { _marker : PhantomData } , SEVEN_SEGMENT : SEVEN_SEGMENT { _marker : PhantomData } , TIMER0 : TIMER0 { _marker : PhantomData } , UART : UART { _marker : PhantomData } , } } }